...
/* 		    clear: both; */
	...
	<div id="content" style="overflow:hidden;">
		...
		<input type="hidden" id="sqbm" name="sqbm" value="${obj.glbm }">
...
<!-- 			</div> -->
		...
		<div style="height:109px;position:relative;margin-bottom:0px;overflow:hidden;">
			<div class="layui-field-box layui-form" style="padding:0px;margin:0px;">
				<div style="color: #3C8DBC;border-bottom: 1px solid #3C8DBC;line-height: 20px;height: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;审批信息</div>
				<div class="frm-row">
					<label class="frm-label frm-col-3">审批结果</label>
					<div class="layui-input-block frm-col-20">
						<div id="audit-shjg"></div>
					</div>
				</div>
				<div class="frm-row" style="margin-bottom:8px;">
					<label class="frm-label frm-col-3">审批意见</label>
					<div class="layui-input-block  frm-col-20">
						<input type="text" id="bz" name="shyj" maxlength="64" placeholder="请输入审批意见" class="layui-input">
					</div>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="gov/js/audit1_edit.js"></script>
