	...
	<body>
		<form id="mainForm" name="mainForm" method="post" class="layui-form">
			...
			<div class="frm-row">
				...
				<div class="frm-col-11 frm-text" id="div-sqry">${ft.sqry } 
				</div>
			</div>
			<div class="frm-row">
				...
				<div class="frm-col-11">
					<input type="text" id="car-jsry" name="jsry" value="${ft.jsry }" lay-verify="required"  maxlength="15"  placeholder="请输入驾驶员姓名" class="layui-input cle" style="width:88%;float:left;">
			...
			<div class="frm-row">
				<label class="frm-label frm-col-4">请休假原因</label>
				<div class="frm-col-19">
					<input type="text" id="car-rwnr" name="rwnr" lay-verify="required" maxlength="248" placeholder="请输入请休假原因" value="${ft.rwnr }"  class="layui-input cle" >
				</div>
			</div>
			<div class="frm-row">
