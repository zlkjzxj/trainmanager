	...
	<body>
		...
		<script type="text/html" id="tpl">
			...
			<tr data-ywlx="{{ item.ywlx }}" data-lsh="{{ item.lsh }}">
				...
				<td class="td8">
					<a href="javascript:;" data-ywlx="{{ item.ywlx }}" data-lsh="{{ item.lsh }}" data-opt="edit"   class="layui-btn layui-btn-mini"><i class="layui-icon">&#xe642;</i> 审核</a>
		...
		<script type="text/javascript" src="gov/js/audit2.js"></script>
