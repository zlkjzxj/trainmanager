    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#shaxinImage').click(function () {//生成验证码
                $('#kaptchaImage').hide().attr('src', '/printRandImg&' + Math.floor(Math.random() * 100)).fadeIn();
            });
        });
    </script>
</head>
<body onkeydown="k_submit(event);">
<form action="/login" style="margin: 0px;" method="post" name="loginform" id="loginform">
    <input type="hidden" id="dlms" name="dlms">
    <div class="container">
        <div class="loginimg">
            <%--<div class="version"><span>xxx</span></div>--%>
        </div>
        <div class="guanggao">
            ...
            <div class="loginB">
                ...
                <div class="hrfrom">
                    <ul>
                        <li>
                            <input class="hrinputA" type="text" placeholder="账号" name="yhdh" id="yhdh" value="${yhdh}"
                                   maxlength="10"/>
                        </li>
                        <li>
                            <input class="hrinputA" type="password" placeholder="密码" name="mm" value="" id="mm"
                                   maxlength="20"/>
                        </li>
                        <li>
                            <input class="hrinputB" type="text" placeholder="请输入验证码" value="" name="yzm" id="yzm"
                                   maxlength="4"/>
                            <img src="/printRandImg" class="yzmimg" id="kaptchaImage"/>
