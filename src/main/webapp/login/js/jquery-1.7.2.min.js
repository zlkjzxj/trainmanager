...
(function(a,b){
	...
	f.event={
		...
		,trigger:function(c,d,e,g){
			if(!e||e.nodeType!==3&&e.nodeType!==8){
				...
				for(l=0;l<r.length&&!c.isPropagationStopped();
	...
	bV=bQ.exec(bU.toLowerCase())||[],f.fn.extend({
		...
		,ajaxSettings:{
			url:bU,isLocal:bI.test(bV[1]),global:!0,type:"GET",contentType:"application/x-www-form-urlencoded; charset=UTF-8",processData:!0,async:!0,accepts:{
	...
	"getBoundingClientRect"in c.documentElement?cv=function(a,b,c,d){
		...
		catch(e){}if(!d||!f.contains(c,a))return d?{
