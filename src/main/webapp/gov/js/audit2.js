layui.config({
	...
	function queryFlowList(){
		...
		var params = {};
		params.sqbm = $('#hidden-flow-glbm').val();
	...
	function openFlowEdit(ywlx,lsh){
		...
		layer.open({
			type: 2,
			id:'flowEdit',
			content:['flow.do?method=forwardFlowEditPage&ymmc=audit2_edit&shlx=1'+condition+condition1],
			title: '业务审核', /*<i class="fa fa-user" style="font-size:18px;color:#1AA094;"></i> */
			shade: 0.2,
			offset: ['30px', '15%'],
			area: ['1000px', '535px'],
			zIndex: 10000000,
